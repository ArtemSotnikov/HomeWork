...
function setLocalStorageInfo(key, value, timeout) {
  ...
  console.log("successfully stored :", localStorage.getItem(key));
  if (timeout > 0) {
    setTimeout(localStorage.removeItem(key), timeout);
  }
}
...
// In this case  userNames was already remove from localStorage -> result is undefined.
